...
from dust_topic.msg import dust_msg	# 패키지의 메시지 파일
...
class Get():
    def __init__(self):
        ...
        self.pub = rospy.Publisher('dust', dust_msg, queue_size=10)
        self.rate = rospy.Rate(5) # 10hz
        self.msg = dust_msg()	# 메시지 변수 선언
        self.count = 0	
...
def main():
    try:
        ...
        while not rospy.is_shutdown():
            ...
            dust.msg.dust = int(dust.pm25Value[station_find])
